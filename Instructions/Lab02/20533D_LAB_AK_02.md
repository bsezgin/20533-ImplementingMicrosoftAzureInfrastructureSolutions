...
1. On the **Create a Virtual Network with two Subnets** blade, specify the following settings and then click **Purchase**.
  ...
  - Resource group: ensure that **Create new** option is selected and type **20533D0202-LabRG** in the text box below

  - Location: _in the drop-down list, select an Azure region close to the location of the lab environment_

  - Vnet Name: **20533D0202-vnet**
...
2. Verify that provisioning of the new virtual network with name **20533D0202-vnet** completed successfully.
